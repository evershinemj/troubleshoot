...
solution:
	...
	/Users/wangxueming/.
		unset HOME will make `~` expanded to /Users/wangxueming/AppData/Roaming/ again.
	to ensure environment variables like HOME are unset or reset, computer needs to be rebooted.
	(this needs to be done for normal gui applications. for cmd, computer needn't be rebooted, as restarting cmd is enough for
	cmd to read environment variables.)
